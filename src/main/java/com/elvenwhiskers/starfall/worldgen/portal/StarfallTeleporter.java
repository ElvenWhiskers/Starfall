package com.elvenwhiskers.starfall.worldgen.portal;
...
public class StarfallTeleporter implements ITeleporter {
    public static BlockPos thisPos = BlockPos.ZERO;
    public static boolean insideDimension = true;

    public StarfallTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destinationWorld.getBlockState(checkPos).getBlock() instanceof StarfallPortalBlock) {
                    doSetBlock = false;
                    break;
                }
            }
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.STARFALL_PORTAL.get().defaultBlockState(), 3);
            }
        }
